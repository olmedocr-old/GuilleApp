...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        PhraseRecyclerAdapter adapter = new PhraseRecyclerAdapter(phrases);
                ...
                new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        for (DataSnapshot postSnapshot : dataSnapshot.getChildren()) {
                            //TODO obtain the full list of phrases from firebase
                        }
                    }
                    @Override
...
//        mDatabase.getRoot().child("Phrases").child("5").setValue(new Phrase("8/3 0:28", "eal hasta la muerte", ""));
